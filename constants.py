...
TXT_CREDITOS =  'Esse Tabalho foi desenvolvido pelo programadores:\n' \
                ...
                '  Ramom Soares Mendes de Menezes Leite;\n' \
...
TXT_AJUDA = 'Objetivo do Jogo:\n' \
            ...
            'a cobra com alimentos que aparecem aleatóriamente na arena. A cada alimento que a cobra come, seu tamanho aumenta em uma unidade.\n' \
            ...
            '  -> Fruta Vermelha: Ao se alimentar dessa fruta, aparecerá uma questão matemática que ao ser respondida corretamente ganha pontos extras, caso erre haverá a diminuição dos pontos.\n' \
            '  -> Fruta Verde: Ao se alimentar dessa fruta, indicará um bônus aleatório, de tempo ou velocidade.\n'\
            '  -> Fruta Amarela: Ao se alimentar dessa fruta, acontecerá algo.\n\n'\
            'Controles:\n' \
