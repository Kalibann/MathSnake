...
class minimalBtn(Deb):
    def __init__(self, text, pos, pos_type='lefttop', size=(140, 30)):
...
class txtChangeBtn(Deb):
    ...
    def action(self):
        ...
        self.text_surf = pygame.font.Font(self.font, self.font_size).render(self.txt_list[self.txt_list_index], True, self.font_off_color)
